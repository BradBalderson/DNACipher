...
dnacipher --help
 ```                                                                                                                                        
    ...
    ╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
    ╭─ Commands ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
    │ version                      Prints the DNACipher version.                                                                                            │
    │ device                       Prints the device that is detected and will be used by DNACipher.                                                        │
    ...
    │                              * 'rare' variants (non-significant rare variants in the same region as the candidate variants),  * 'background' variants │
    │                              (common non-significant variants), and 'other' variants (rare variants outside of the hit locus).                        │
